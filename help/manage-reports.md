...
다음으로 이동 **[!UICONTROL 설정]** > **[!UICONTROL 라이브 통계]** 자동으로 생성된 다음 차트를 보려면 다음을 수행합니다.

* **다운로드**: 라인 차트를 사용하여 표시된 최근 30일 또는 12개월 동안의 Assets Essentials 환경에서 다운로드한 자산의 수입니다.

* **업로드**: 라인 차트를 사용하여 표시된 지난 30일 또는 12개월 동안 Assets Essentials 환경에 업로드된 자산 수입니다.
...
1. 에서 [!UICONTROL 구성] 탭에서 보고서 유형을 **[!UICONTROL 다운로드]**.

1. 보고서에 대한 제목과 선택적 설명을 지정합니다.
...
1. 에서 [!UICONTROL 구성] 탭에서 보고서 유형을 **[!UICONTROL 업로드]**.
