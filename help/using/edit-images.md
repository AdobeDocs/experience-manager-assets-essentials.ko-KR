...
[!DNL Assets Essentials]는 [!DNL Adobe Express]에서 제공하는 사용자 친화적인 편집 옵션을 제공합니다. [!DNL Adobe Express]로 사용할 수 있는 편집 작업에는 이미지 크기 조정, 배경 제거, 이미지 자르기, JPEG를 PNG로 변환하기 등이 있습니다.
