...
[!DNL Assets Essentials] 는에서 제공하는 사용자 친화적인 편집 옵션을 제공합니다. [!DNL Adobe Express] 및 [!DNL Adobe Photoshop Express]. 를 사용하여 사용할 수 있는 편집 작업 [!DNL Adobe Express] 이미지 크기 조정, 배경 제거, 이미지 자르기 및 JPEG을 PNG로 변환 중에서 선택할 수 있습니다.

이미지를 편집한 후 새 이미지를 새 버전으로 저장할 수 있습니다. 필요한 경우 버전 관리를 통해 나중에 원본 에셋으로 되돌릴 수 있습니다. 이미지를 편집하려면 [미리보기 열기](/help/using/navigate-view.md#preview-assets) 및 클릭 **[!UICONTROL 이미지 편집]**.
...
5. 클릭 **[!UICONTROL 적용]** 변경 사항을 적용합니다.
   ...
   ![Adobe Express으로 이미지 저장](/help/using/assets/adobe-express-resize-save.png)
...
>[!MORELIKETHIS]
>
>* [에셋의 버전 내역 보기](/help/using/navigate-view.md)
