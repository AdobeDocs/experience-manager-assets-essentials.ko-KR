...
>title="내 작업 영역"
>abstract="Assets에는 Assets 사용자 인터페이스의 주요 영역에 간편하게 액세스할 수 있는 위젯과 사용자와 가장 관련이 있는 정보를 제공하는 사용자 정의 가능한 작업 영역이 포함되어 있습니다. 이 페이지는 작업 항목에 대한 개요 및 주요 워크플로에 대한 빠른 액세스를 제공하는 종합적인 솔루션 역할을 합니다."
