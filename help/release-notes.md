...
* [!DNL Adobe Workfront]와의 통합을 통해 [!DNL Workfront] 사용자가 작업 관리의 맥락에서 디지털 자산을 관리할 수 있습니다. 자세한 내용은 [다른 Adobe 솔루션과 통합](/help/integration.md)을 참조하십시오.
...
* [!DNL Assets Essentials]는 [!DNL Adobe Journey Optimizer] 사용자가 메시지를 작성할 때 자산을 관리하는 데 사용할 수 있습니다. 자세한 내용은 [다른 Adobe 솔루션과 통합](/help/integration.md)을 참조하십시오.
