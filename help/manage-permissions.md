...
![자산을 선택할 때의 도구 모음 옵션](assets/permissions-management-new.png)
...
![권한 할당](assets/permissions-management-groups-new.png)
...
![권한 할당](assets/permissions-inheritance-new.png)
