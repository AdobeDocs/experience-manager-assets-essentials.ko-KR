...
Assets Essentials 알림을 사용하면 저장소에서 사용할 수 있는 에셋 또는 폴더에서 수행된 작업을 모니터링할 수 있습니다. 알림을 받을 콘텐츠를 선택하고 구독해야 합니다. 알림을 받을 범주를 구성할 수도 있습니다.
...
<table>
    <tbody>
     ...
     <tr>
      <td>구독한 콘텐츠 삭제</td>
      <td>사용자가 구독한 에셋 또는 폴더를 삭제하는 경우 알림을 받습니다.</td>
     </tr>
     <tr>
      <td>구독한 콘텐츠의 외부 공유</td>
      <td>사용자가 구독한 에셋 또는 폴더에 대한 공개 링크를 생성하는 경우 알림을 받습니다.</td>
     </tr>
     <tr>
      <td>구독한 콘텐츠 수정</td>
     ...
     <tr>
      ...
      <td>사용자가 구독한 폴더에서 에셋을 추가하거나 제거하는 경우 알림을 받습니다.</td>
     </tr>    
    </tbody>
   </table>
...
## 폴더 또는 에셋 보기 및 보기 취소 {#watch-unwatch-assets}
...
콘텐츠를 구독하려면 구독해야 하는 폴더 또는 에셋을 선택한 다음 **[!UICONTROL 보기]**&#x200B;를 클릭합니다.
...
이제 Assets Essentials이 구독한 범주에 대한 알림을 전송합니다. 여러 에셋 또는 폴더를 선택하고 **[!UICONTROL 보기]**&#x200B;를 클릭하여 시간을 절약할 수 있습니다. 그러나 일부를 이미 구독한 여러 엔티티를 선택한 경우 **[!UICONTROL 보기]** 옵션이 표시되지 않습니다.

마찬가지로 구독을 취소하려면 구독한 에셋 또는 폴더를 선택하고 **[!UICONTROL 보기 취소]**&#x200B;를 클릭합니다.
